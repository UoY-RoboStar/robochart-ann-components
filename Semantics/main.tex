...
\begin{TRule}[Function ANNChannels \\]{\meta{ANNChannels(c : ANNController, l, n : \nat) : Program =}}
  \begin{array}[t]{l}
    ...
    \begin{array}[t]{l}
      ...
      \meta{if(l \neq 0)} \\%
      \t1 % 
      \meta{NodeOutChannels(l, n, \# c.annparameters.layerstructure)} \\%
      \meta{if (n > 1)} \\%
      \t1 %
      \begin{array}[t]{l}
 ...
 CSPAction =}}
  \begin{array}[t]{l} 
    ...
    \begin{array}[t]{l}
      ...
      \lcircguard l = \meta{l} \land n = \meta{n} \land i = \meta{i} \rcircguard \circguard \\%
      \t1 %
      \meta{\meta{layerRes(l,n)}?x \then \meta{nodeOut(l, n, i)}!(x * \meta{weight(c, l, n, i)}) \then \Skip  }
    \end{array}
  \end{array} \\%
  \label{rule:nodein}
\end{TRule} 
...
\begin{TRule}[Function layerNo (number of layers) \\]{\meta{layerNo(c : ANNController) : \nat =}}
  \begin{array}[t]{l}
    \# ((list \inv)~c.annparameters.layerstructure)
  \end{array} 
  \label{rule:layerno}
\end{TRule} 
...
\begin{TRule}[Function weight \\]{\meta{weight(c : ANNController; l, n, i : \nat) : Value =}}
  \begin{array}[t]{l}
    ((tensor \inv)~c.annparameters.weights)~l~n~i
  \end{array} 
  \label{rule:weight}
\end{TRule} 
...
\begin{TRule}[Function bias \\]{\meta{bias(c : ANNController; l, n : \nat) : Value =}}
  \begin{array}[t]{l}
    ((matrix \inv)~c.annparameters.biases)~l~n
  \end{array} 
  \label{rule:bias}
\end{TRule} 
...
\begin{figure}[h]
  ...
  \begin{zed}
    ...
    OutputLayer = \Parallel i : 1 \upto layerSize(layerNo)-1 @  \; [ \; \{| layerRes.(layerNo-1) |\} \; ] 
    \\
    \t2
