...
public class Output_Layer implements CSProcess {
	...
	/*@ spec_public nullable @*/ Output_Node[] nodes;
	...
	//LayerType object, decided by class not by input. 
	/*@ spec_public @*/ LayerType type;
	...
	//@ pure
	public Output_Layer(int layer_size, int input_size, /*@ nullable @*/ double[][] weights, /*@ nullable @*/ double[] bias, /*@ nullable @*/ ChannelInput[] layer_input, ChannelOutput[] layer_output) {
		this.layer_size = layer_size;
		this.weights = weights;
		this.bias = bias;
		this.layer_input = layer_input;
		this.layer_output = layer_output;
		this.type = LayerType.Fully_Connected;
	...
	public void run() { 
		...
		nodes = new Output_Node[layer_size];
		...
		if(weights != null && bias != null && layer_input != null) {
			...
			for(int i = 0; i < layer_size; i++) {
				nodes[i] = new Output_Node(input_size, weights[i], bias[i], layer_input);
			}
		}
